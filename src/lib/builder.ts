...
export const STYLE_PRESETS: StylePreset[] = [
  ...
  },
  {
    id: 'aurora-glass',
    label: 'Aurora Glass',
    description: 'Ethereal glassmorphism for premium showcase pages and OS home screens',
    tags: ['premium', 'glass', 'aurora', 'modern', 'premium-showcase'],
    config: {
      themePreset: 'frosted-glass',
      mode: 'dark',
      backgroundStyle: 'aurora',
  ...
  },
  {
    id: 'deep-space',
    label: 'Deep Space',
    description: 'Cosmic console for AI tools, cyber applications, and space-themed dashboards',
    tags: ['premium', 'dark', 'cyber', 'space', 'ai-tools'],
    config: {
      themePreset: 'cyber-neon',
      mode: 'dark',
  ...
  },
  {
    id: 'linux-frost',
    label: 'Linux Frost',
    description: 'Linux workstation aesthetic for OS project migration and dev environments',
    tags: ['premium', 'linux', 'workstation', 'frosted', 'dev-tools'],
    config: {
      themePreset: 'kali-dark',
      mode: 'dark',
      backgroundStyle: 'frosted-panel',
      layoutStyle: 'sidebar',
      dockStyle: 'glass-dock',
      panelChrome: 'linux',
      borderStyle: 'subtle',
  ...
  },
  {
    id: 'terminal-pro',
    label: 'Terminal Pro',
    description: 'Terminal engineer aesthetic for developer tools and security consoles',
    tags: ['premium', 'terminal', 'developer', 'security', 'console'],
    config: {
      themePreset: 'unix-terminal',
      mode: 'dark',
      backgroundStyle: 'terminal-matrix',
  ...
  },
  {
    id: 'cyber-neon',
    label: 'Cyber Neon',
    description: 'Neon cyberpunk aesthetic for premium demos and screenshot sharing',
    tags: ['premium', 'neon', 'cyberpunk', 'demo', 'showcase'],
    config: {
      themePreset: 'cyber-neon',
      mode: 'dark',
      backgroundStyle: 'starfield',
  ...
  },
  {
    id: 'paper-minimal',
    label: 'Paper Minimal',
    description: 'Clean paper aesthetic for articles, documentation, and blogs',
    tags: ['premium', 'light', 'paper', 'blog', 'documentation'],
    config: {
      themePreset: 'warm-paper',
      mode: 'light',
      backgroundStyle: 'minimal-paper',
  ...
  },
  {
    id: 'ocean-panel',
    label: 'Ocean Panel',
    description: 'Blue-green control panel aesthetic for SaaS and dashboard applications',
    tags: ['premium', 'blue', 'saas', 'dashboard', 'professional'],
    config: {
      themePreset: 'oceanic',
      mode: 'dark',
      backgroundStyle: 'soft-gradient',
  ...
  },
  {
    id: 'warm-studio',
    label: 'Warm Studio',
    description: 'Warm creative workspace for content tools and design studios',
    tags: ['premium', 'warm', 'creative', 'design', 'studio'],
    config: {
      themePreset: 'amber-studio',
      mode: 'light',
      backgroundStyle: 'spotlight-stage',
      layoutStyle: 'dashboard-grid',
      dockStyle: 'floating-shelf',
      panelChrome: 'studio',
      borderStyle: 'subtle',
