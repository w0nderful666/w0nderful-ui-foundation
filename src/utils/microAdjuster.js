import { MICRO_PRESETS } from '../data/seriesMicroPresets.js'
...
export function applyMicroAdjust(director, presetId, options = {}) {
  const preset = MICRO_PRESETS.find(p => p.id === presetId)
  if (!preset) {
...
export function applyMicroAdjustToSeries(series, presetId, options = {}) {
